...
def SceneLoadRun(self):
    ...
    pygame.draw.rect(self.game.screen, (180, 180, 180),
                     (self.game.screen_width/2-300, self.game.screen_height/2-250, 600, 500))
    pygame.draw.rect(self.game.screen, (150, 150, 150),
                     (self.game.screen_width/2-250, self.game.screen_height/2-200, 500, 400))
...
def SceneLoadGamehandleEventsFunc(self, event):
    if event.type == event_types["LaunchGame"]:
        ...
        self.game.save.load(self.box["inputbox"].text)
    ...
    if event.type == event_types["LoadName"]:
        ...
        self.box["inputbox"].txt_render = self.box["inputbox"].font.render(
            self.box["inputbox"].text, True, (0, 0, 0))
